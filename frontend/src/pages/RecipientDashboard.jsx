...
const styles = {
  ...
  tab: { background: colors.light, color: colors.muted, border: 'none', padding: '9px 16px', borderRadius: 6, fontSize: 14, fontWeight: 600, cursor: 'pointer', flex: 1, minWidth: 120 },
  ...
  empty: { background: colors.surface, borderRadius: 12, padding: 'clamp(32px, 6vw, 60px)', textAlign: 'center', boxShadow: shadows.panel },
  browsBtn: { background: colors.primary, color: '#fff', padding: '10px 24px', borderRadius: 6, textDecoration: 'none', fontSize: 14, fontWeight: 600, display: 'inline-block' },
  grid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(min(100%, 260px), 1fr))', gap: 20 },
  card: { background: colors.surface, borderRadius: 12, padding: 'clamp(16px, 3vw, 24px)', boxShadow: shadows.panel, display: 'flex', flexDirection: 'column', gap: 8 },
  cardIcon: { fontSize: 36 },
  cardType: { fontSize: 'clamp(15px, 2.5vw, 18px)', color: colors.dark, margin: 0 },
  ...
  code: { background: colors.light, padding: '2px 6px', borderRadius: 4, fontSize: 12, wordBreak: 'break-all' },
  actions: { display: 'flex', gap: 10, flexWrap: 'wrap' },
  dlBtn: { background: colors.secondary, color: colors.surface, padding: '8px 14px', borderRadius: 6, textDecoration: 'none', fontSize: 13, textAlign: 'center', flex: 1, minWidth: 100 },
  verifyLink: { background: colors.light, color: colors.dark, padding: '8px 14px', borderRadius: 6, textDecoration: 'none', fontSize: 13, textAlign: 'center' },
