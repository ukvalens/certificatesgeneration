...
const styles = {
  section: { background: colors.surface, borderRadius: 12, padding: 'clamp(16px, 3vw, 24px)', marginBottom: 24, boxShadow: '0 2px 12px rgba(0,0,0,0.06)' },
  sectionTitle: { fontSize: 16, fontWeight: 700, color: colors.dark, marginBottom: 16 },
  form: { display: 'flex', flexDirection: 'column', gap: 10 },
  row: { display: 'flex', gap: 10, flexWrap: 'wrap' },
  input: { flex: 1, padding: '9px 12px', border: `1px solid ${colors.border}`, borderRadius: 6, fontSize: 14, color: colors.dark, minWidth: 0, boxSizing: 'border-box', width: '100%' },
  textarea: { padding: '9px 12px', border: `1px solid ${colors.border}`, borderRadius: 6, fontSize: 14, color: colors.dark, resize: 'vertical', fontFamily: 'inherit', width: '100%', boxSizing: 'border-box' },
  select: { flex: 1, padding: '9px 12px', border: `1px solid ${colors.border}`, borderRadius: 6, fontSize: 14, color: colors.dark, minWidth: 0, width: '100%' },
  ...
  courseRow: { display: 'flex', alignItems: 'flex-start', gap: 12, padding: '12px 16px', flexWrap: 'wrap' },
  meta: { color: colors.muted, fontSize: 13 },
  certTag: { background: 'rgba(40,167,69,0.1)', color: '#1b6f35', fontSize: 11, padding: '2px 8px', borderRadius: 10, marginLeft: 8 },
  courseActions: { display: 'flex', gap: 6, flexWrap: 'wrap', flexShrink: 0 },
  ...
  lessonsPanel: { background: colors.light, padding: 'clamp(12px, 2vw, 20px)', borderTop: `1px solid ${colors.light}` },
  lessonsPanelTitle: { fontSize: 14, fontWeight: 700, color: colors.dark, marginBottom: 12 },
  lessonRow: { display: 'flex', alignItems: 'center', gap: 10, padding: '8px 0', borderBottom: `1px solid rgba(0,0,0,0.05)`, flexWrap: 'wrap' },
